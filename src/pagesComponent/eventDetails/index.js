    ...
    >
      ...
      <Grid item className={classes.container} style={{ width: '100%', marginTop: '35px' }}>
        <div className={classes.innerContainer}>
          ...
          <Grid container spacing={2} style={{ marginTop: '10px' }}>
            {props.event.speakers.map((s, i) => (
              <Grid item key={i}>
                <div style={{ position: 'relative', zIndex: 2 }}>
                  <div
                    style={{
                      backgroundColor: 'rgba(93,93,93,.4)',
                      width: '100%',
                      zIndex: '0',
                      position: 'absolute',
                      height: '100%',
                  ...
                  />
                  <div style={{ position: 'absolute', left: 13, bottom: 13, zIndex: 2 }}>
                    <Typography
                      variant="subtitle2"
                      style={{
                        color: '#fff',
                    ...
                    {(s.facebook ||
                      ...
                      <div style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
                        {s.facebook && (
                          <a href={s.facebook} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                        ...
                        {s.twitter && (
                          <a href={s.twitter} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                        ...
                        {s.insta && (
                          <a href={s.insta} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id="clip0_32_420">
                                  <path
                                    fill={theme.palette.primary.main}
                                    d="M0.672 0.485H32.699V32.512H0.672z"
                                  ></path>
                                </clipPath>
                              </defs>
                            </svg>
                        ...
                        {s.linkdin && (
                          <a href={s.linkdin} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id="clip0_32_421">
                                  <path
                                    fill={theme.palette.primary.main}
                                    d="M0.168 0.485H32.195V32.512H0.168z"
                                  ></path>
                                </clipPath>
                                <clipPath id="clip1_32_421">
                                  <path
                                    fill={theme.palette.primary.main}
                                    d="M6.84 7.157H25.523V25.84H6.84z"
                                  ></path>
                                </clipPath>
                              </defs>
                            </svg>
                        ...
                        {s.snapchat && (
                          <a href={s.snapchat} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                        ...
                        {s.whatsApp && (
                          <a href={s.whatsApp} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18"
                              height="18"
                  ...
                  <img
                    src={`${publicRuntimeConfig.REACT_APP_API_URL}/files/speakers/${s.image}`}
                    style={{
                      width: '295px',
                      height: 'auto',
                      borderRadius: '10px',
      ...
      <Grid item className={classes.container} style={{ width: '100%', marginTop: '35px' }}>
        <div className={classes.innerContainer}>
          ...
          <Grid container direction="column">
            {props.event.schedule.map((s, i) => (
              <Grid item key={i} style={{ marginTop: '18px' }}>
                <Accordion
                  classes={{
                    root: classes.paper,
                  }}
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMoreIcon className={classes.paperPadding} />}
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid item>
                        <Typography
                          variant="subtitle2"
                          style={{ color: '#B1B1B1', fontWeight: '700', fontSize: '18px' }}
                        >
                          {moment(s.startDate).format('MMMM DD,yyyy')}
                        </Typography>
                      </Grid>
                      {/* for time */}
                      <Grid item>
                        ...
                        >
                          {moment(s.startDate).format('hh:mm a')}
                        </Typography>
                      </Grid>
                      {/* topic */}
                      <Grid item>
                  ...
                  <AccordionDetails style={{ padding: 0 }}>
                    ...
                    >
                      ...
                      <Grid container spacing={3} alignItems="center" style={{ marginTop: '18px' }}>
                        <Grid item>
                          <Typography
                            variant="subtitle2"
                            style={{
