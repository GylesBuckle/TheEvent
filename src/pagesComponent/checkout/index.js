...
const eventData = {
  ...
  sponsors: [
    "1667001427737-pexels-jd-danny-2385477.jpg",
    "1667001427739-Untitled-1 copy.png",
  ],
            ...
            <TableBody>
              <TableRow>
                ...
                >
                  ...
                  >
                    {moment(event.startDate).format("MMMM DD,yyyy")}{" "}
                    {event.venue}
                  </Typography>
                </TableCell>
                <TableCell
      ...
      <Grid item style={{ width: "100%", marginTop: "30px" }}>
        ...
        >
          ...
          <Grid item md={6} xs={12}>
            ...
            {/* email */}
            <div
              className={[classes.extraSpace].join(" ")}
              style={{ marginTop: "25px" }}
            >
              <TextField
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src={
                        `${publicRuntimeConfig.REACT_APP_ASSET_PREFIX}dev/testnomials/` +
                        item.profile
                      }
                      style={{
                        width: "33px",
